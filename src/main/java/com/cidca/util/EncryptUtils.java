...
public class EncryptUtils {
    ...
    private final static String secretKey = "Cidca#80";
    ...
    // 密钥
    private final static String secretKey2 = "thismy3desdemotestsecretKey";
    // 向量
    private final static String iv2 = "01234567";
    // 加解密统一使用的编码方式
    private final static String encoding2 = "utf-8";
     ...
     * @throws Exception
     */
    public static String encode2(String plainText) throws Exception {
        Key deskey = null;
        DESedeKeySpec spec = new DESedeKeySpec(secretKey2.getBytes());
        ...
        byte[] encryptData = cipher.doFinal(plainText.getBytes(encoding2));
        return Base64.encode(encryptData);
    }
	
    public static void main(String[] args) throws Exception {
        String plainText = "[{\"user\":\"14242919881234567\",\"mobile\":\"13718651580\"}]";
