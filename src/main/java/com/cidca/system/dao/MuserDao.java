...
public interface MuserDao extends JpaRepository<TMuser, Integer>,JpaSpecificationExecutor<AidMsgSubclass>{
		...
		public List<TMuser> findByIdcardAndPassword(@Param("idcard")String userid, @Param("password")String password);
